            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <a href="{{ route('forum',['filter' => 'me']) }}" style="text-decoration: none;;">My discussion</a>
                            </li>
                            <li class="list-group-item">
                                <a href="{{ route('forum',['filter' => 'solved']) }}" style="text-decoration: none;;">Answered Discussion</a>
                            </li>
                            <li class="list-group-item">
                                <a href="{{ route('forum',['filter' => 'unsolved']) }}" style="text-decoration: none;">Unanswer Discussion</a>
                            </li>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Channels&nbsp;&nbsp;<a href="#"><i class="fa fa-minus-circle"></i></a>&nbsp;
                    </div>
                    <div class="panel-body">
                        <ul class="list-group">
